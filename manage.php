                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
								$query = mysql_query("select * from event where event_id = '$session_id'")or die(mysql_error());
									while($row = mysql_fetch_array($query)){
								?>
									<div id="del<?php echo $row['event_id'];?>" class="alert"><i class="icon-list"></i> <?php echo strtoupper(substr($row['note'], 0, 30-2) . '&#133'); ?> 
